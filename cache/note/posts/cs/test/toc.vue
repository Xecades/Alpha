<script setup>import {onMounted} from "vue";const emit = defineEmits(['mounted']);onMounted(()=>{emit("mounted")})</script><template><h2 id="t" tabindex="-1" class="heading">普通标题 <a class="cursor header-anchor" href="#t">¶</a></h2>
...
<h4 id="t-6" tabindex="-1" class="heading">这个标题内还有 <inline-math data="%5CLaTeX"></inline-math> 数学公式 <a class="cursor header-anchor" href="#t-6">¶</a></h4>
