<script setup>import {onMounted} from "vue";const emit = defineEmits(['mounted']);onMounted(()=>{emit("mounted")})</script><template><p>普通文字</p>
<hr />
...
<hr />
<ul class="task-list">
<li class="task-list-item"><div class="checkbox" /><input type="checkbox" id="cbx_0" checked="true" disabled="true" /><label for="cbx_0"> 选中</label></div></li>
<li class="task-list-item"><div class="checkbox" /><input type="checkbox" id="cbx_1" disabled="true" /><label for="cbx_1"> 未选中</label></div></li>
</ul>
<hr />
...
<hr />
<p>图片展示</p>
<p><image-captioned alt="这里是图片标题，支持 [公式] 和 加粗 文字" src="https://medium-zoom.francoischalifour.com/image-3.a41d7456.jpg">这里是图片标题，支持 <inline-math data="%5CLaTeX"></inline-math> 和<strong>加粗</strong>文字</image-captioned></p>
<p><image-captioned alt="cat /data/flag" src="https://medium-zoom.francoischalifour.com/image-4.a4d08f7d.jpg"><code>cat /data/flag</code></image-captioned></p>
<p><image-captioned alt="" src="https://s2.loli.net/2022/07/09/pTQyYHRSXjLCtFU.png"></image-captioned></p>
<hr />
<blockquote>
<blockquote>
<blockquote>
